    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', autoslug.fields.AutoSlugField(populate_from='title', unique=True, always_update=True))
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'New'), ('In Progress', 'In Progress'), ('Checking', 'Checking'), ('Sent', 'Sent'), ('Arrived', 'Arrived')], default='New', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order_reviews', to='marketplace.order')),
        ...
        migrations.AddField(
            model_name='order',
            name='org_work',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='received_orders', to='authorization.organization'),
        ),
        migrations.CreateModel(
